...
class mSql extends CI_Model {
	...
	function insert_resource($r, $producer, $model, $name, $type) {
		$insert_data = array('resource_uuid' => $r, 'resource_producer' => $producer, 'resource_model' => $model, 'resource_name' => $name, 'resource_type' => $type);
