...
<?php
	...
	echo form_open('oaslogon/validate', $attributes);
?>
    <h1>Log In</h1>
    <?php
		if ($this->session->flashdata('err_msg') != FALSE)
			echo '<h4 style="text-align: center; color: red;">'.$this->session->flashdata('err_msg').'</h4>';
	?>
    <fieldset id="inputs">
